...
static const struct reg_field bq25890_reg_fields[] = {
	...
	[F_MIN_VBAT_SEL]	= REG_FIELD(0x03, 0, 0), /* BQ25896 */
	/* REG04 */
	...
	/* REG08 */
	[F_BATCMP]		= REG_FIELD(0x08, 6, 7), // 5-7 on BQ25896. TODO: check 25890 DS
	...
	[F_PFM_OTG_DIS]		= REG_FIELD(0x0A, 3, 3), //BQ25896
